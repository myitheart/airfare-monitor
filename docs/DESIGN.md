...
1. Load the four enabled legs and validate airport codes, dates and ETD windows.
...
10. Generate one Excel workbook and one email summary covering all four legs.
...
- Four routes collected serially to avoid overlapping search sessions.
- One consolidated email every 30 minutes, not one email per leg.
...
- `success`: all four enabled legs completed.
